...
![alt text](/thanhlai/post/buffer_overflow/image/post2/image.png)
...
![alt text](/thanhlai/post/buffer_overflow/image/post2/image-1.png)

<p>Cơ chế canary đang được bật -> Phải leak được giá trị canary. Ta có thể lợi dụng hàm printf để leak ra giá trị canary. </p>

![alt text](/thanhlai/post/buffer_overflow/image/post2/image-7.png)
...
![alt text](/thanhlai/post/buffer_overflow/image/post2/image-5.png)
...
![alt text](/thanhlai/post/buffer_overflow/image/post2/image-6.png)